...
public class ShippingCostCalculator {
    ...
    //Constant representation the cost factors
    ...
    /**
     * Calculate the shipping cost based on the weight,destination and delivery speed.
     *
    ...
    public double calculatorCost(double weight,String destination,String deliverySpeed){
        double cost = 0 ;
